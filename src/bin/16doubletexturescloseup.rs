...
pub fn main() -> Result<(), String> {
    ...
    texture.set_parameter(gl::TEXTURE_MIN_FILTER, gl::NEAREST);
    texture.set_parameter(gl::TEXTURE_MAG_FILTER, gl::NEAREST);
    {
    ...
    texture2.set_parameter(gl::TEXTURE_MIN_FILTER, gl::NEAREST);
    texture2.set_parameter(gl::TEXTURE_MAG_FILTER, gl::NEAREST);
    {
