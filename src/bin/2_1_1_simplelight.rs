...
const VERTEX_SHADER: &'static str = include_str!("shaders/06.1-simplelightvertex.glsl");
const FRAGMENT_SHADER: &'static str = include_str!("shaders/06.1-simplelightfragment.glsl");
