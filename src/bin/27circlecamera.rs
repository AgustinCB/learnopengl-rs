...
use nalgebra::{Matrix4, Perspective3, Point3, Rotation, Rotation3, Scale3, Translation3, Vector3};
...
pub fn main() -> Result<(), String> {
    ...
    'gameloop: loop {
        ...
        program.use_program();
        vertex_array.bind();
        let cam_x = ticks.sin() * 10f32;
        let cam_z = ticks.cos() * 10f32;
        let look_at = Matrix4::look_at_rh(&Point3::new(cam_x, 0f32, cam_z), &Point3::new(0f32, 0f32, 0f32), &Vector3::y_axis());
