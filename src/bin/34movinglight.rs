...
pub fn main() -> Result<(), String> {
    ...
    let mut cube_positions: [Vector3<f32>; 2] = [
    ...
    'gameloop: loop {
        ...
        let light_x = delta_time * ticks.sin();
        let light_z = delta_time * ticks.cos();
        let mov = Vector3::new(light_x, 1f32, light_z).normalize();
        cube_positions[1] = cube_positions[0] + mov;
